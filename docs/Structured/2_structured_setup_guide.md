...
- `Nova Pro`를 선택한 뒤, `Request model access`를 클릭합니다.  
...
- `Nova Pro`에 대한 권한이 추가된 것을 확인하실 수 있습니다.  

![u-b-15](img/u-b-15.png)  

b2. 이후, 새로고침을 해보시면 Nova를 선택할 수 있게 된 것을 확인할 수 있습니다.  
따라서, Amazon을 선택하고, Nova Pro를 선택한 뒤, `Apply`를 클릭합니다.  
